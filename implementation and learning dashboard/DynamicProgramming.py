...
def value_iteration(environment, cost, n_actions, tol, n_state):
    '''
    This function calculates the optimal policy using value iteration.
    
    Args:
        environment: dictionary of transition probabilities per action.
        cost: dictionary of cost per action.
        n_actions: number of actions.
        tol: epsilon value for the tolerance level for convergence.
